...

{
  ...
  // the enemy stats must reflect their current state after this turn
  // name must be unique in enemies array, name could also be a persons real name if known
  "enemies": [
    {"name": "Bandit 1", "hp": 35, "maxHp": 50,"armor": 2, "minDmg": 5, "maxDmg": 10}, 
